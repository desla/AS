    ...
    public class AsioOut : IWavePlayer
    {
        ...
        public int ChannelOffset {
            ...
            set
            {
                ...
                driver.SetChannelOffset(this.channelOffset, InputChannelOffset);
            }
        }
        ...
        public int InputChannelOffset {
            get { return this.inputChannelOffset; }
            set
            {
                this.inputChannelOffset = value;
                driver.SetChannelOffset(ChannelOffset, this.inputChannelOffset);
            }
        }
