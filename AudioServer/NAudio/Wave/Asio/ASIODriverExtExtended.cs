...
namespace NAudio.Wave.Asio
{
    ...
    /// </summary>
    internal delegate void ASIOFillBufferCallbackExtended(IntPtr[] inputChannels, IntPtr[] outputChannels);

    /// <summary>
    ///     Расширение ASIODriverExt, коророе во взаимодействии с AsioOutExtended позволяет
    ///     обрабатывать входные/выходные каналы параллельно.
    ///     Денис Зинченко, ООО АльваСофт, 2015
    ///     denis.zinchenko@alvasoft.ru
    /// </summary>
    internal class ASIODriverExtExtended
    {
        ...
        private ASIOFillBufferCallbackExtended fillBufferCallback;
        ...
        public ASIODriverExtExtended(ASIODriver driver)
        {
            this.driver = driver;
        ...
        public ASIOFillBufferCallbackExtended FillBufferCallback
        {
        ...
        public int CreateBuffers(int numberOfOutputChannels, int numberOfInputChannels, bool useMaxBufferSize)
        {
            ...
            currentOutputBuffers = new IntPtr[capability.NbOutputChannels];
            currentInputBuffers = new IntPtr[capability.NbInputChannels];
        ...
        private void BuildCapabilities()
        {
            ...
            ASIOError error = driver.GetLatencies(out capability.InputLatency, out capability.OutputLatency);
            ...
            // Get BufferSize
            driver.getBufferSize(out capability.BufferMinSize,
                out capability.BufferMaxSize,
                out capability.BufferPreferredSize,
        ...
        private void BufferSwitchCallBack(int doubleBufferIndex, bool directProcess)
        {
            ...
            for (int i = 0; i < capability.NbOutputChannels; ++i) {
                currentOutputBuffers[i] = bufferInfos[i + capability.NbInputChannels].Buffer(doubleBufferIndex);
            }
