...
namespace Alvasoft.AudioServer.ChannelsManager.Impl
{
    ...
    {
        private int seconds = 10;//2 * 60; // максимальное время записи одного сообщения.            
        ...
        private ChannelManager callback;
        ...
        public static InputDevice FindPhysicalDeviceByName(string aDeviceName)
        {
            int channelCount;
            int deviceId;
            ...
            return new InputDevice(aDeviceName, deviceId, channelCount);
        }    
        ...
        public void SetCallback(ChannelManager aCallback)
        {
            callback = aCallback;
        }
        ...
        private InputDevice(string aDeviceName, int aDeviceId, int aChannelCount)
        {
