...
namespace Alvasoft.AudioServer.ChannelsManager.Impl
{
    ...
    {
        private static readonly ILog Logger = LogManager.GetLogger("OutputChannel");

        private OutputChannelInfo channelInfo; // ссылка на конфигурацию
        private IOutputDevice device; // Ссылка на физическое устройство        
        ...
        public OutputChannel(OutputChannelInfo aChannelInfo, IOutputDevice aDevice, ChannelGroup aGroup)
        {            
        ...
        public OutputChannelInfo GetChannelInfo()
        {
            return channelInfo;
        }
